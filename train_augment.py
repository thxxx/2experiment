...
from audiodataset_augment import AudioDataset, TestDataset
...
def main():
    ...
    with accelerator.main_process_first():
        if cfg.resume_from_checkpoint:
            if cfg.resume_from_checkpoint is not None or cfg.resume_from_checkpoint != "":
                model.load_state_dict(torch.load("./output_dir_finetune_augment/58.pth"), strict=False)
    ...
    starting_epoch, completed_steps, best_loss, save_epoch = 58, 0, np.inf, 58
